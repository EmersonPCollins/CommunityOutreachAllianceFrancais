...
public class LocalDatabaseHandlerTest {
    ...
    public void testInsertEvents_validEventInserted_eventGetsCommitted() {
        ...
        Event event = new Event(id, "event: " + id, "test event", "2017-20-21", "", 1.34, 1.52, "address", "english desc", "", "");
    ...
    public void testGetAllEvents_eventsExist_returnsNonEmptyList() {
        Event event = new Event("1", "event: 1", "test event", "2017-20-21", "", 1.1, 1.2, "address", "english", "", "");
        db.insertEvent(event);
    ...
    public void testGetAllEvents_manyEventsExist_returnsAllPages() {
        for (int i = 1; i <= 2000; i++) {
            Event event = new Event(String.valueOf(i), "event: 1", "test event", "2017-20-21", "", 1.1, 1.2, "address", "english", "", "");
            db.insertEvent(event);
        }
